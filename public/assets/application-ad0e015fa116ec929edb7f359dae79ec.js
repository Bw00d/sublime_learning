...
(function() {
  var handleKeyBindings, recordSequence;
  ...
  handleKeyBindings = function() {
    ...
    if (mouseTrapRails.showOnLoad) {
      mouseTrapRails.toggleHints();
    }
    Mousetrap.reset;
    Mousetrap.bind({
      'ctrl+super+up': function() {
        return moveLinesUp();
      },
      'ctrl+super+down': function() {
    ...
    return Mousetrap.bindGlobal({
      '4': function() {
        return alert('4 pressed');
      }
    });
  };

  recordSequence = function() {
    return Mousetrap.record(function(sequence) {
      return alert('You pressed: ' + sequence.join(' '));
    });
  };
...
CodeMirror.defineMode("ruby", function(config) {
  ...
  var keywords = wordObj([
    ...
    "elsif", "END", "end", "ensure", "false", "for", "if", "in", "module","new", "next", "not", "or",
...
(function(mod) {
  ...
  cmds[map["Cmd-" + "Ctrl-" + "Up"] = "swapLineUp"] = function(cm) {
  ...
  cmds[map["Cmd-" + "Ctrl-" + "Down"] = "swapLineDown"] = function(cm) {
